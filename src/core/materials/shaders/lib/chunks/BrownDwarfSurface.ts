...
export const brownDwarfSurface = `
  ...
  // Домен НЕ коробленный: это не приближение высоты из bdField, а второе
  // независимое поле. Для художественного сдвига на пару текселей годится
  // любая, а полный bdField ради одного канала стоил бы восемнадцати октав.
