 ...
 *
 * Оптическая толща аэроперспективы камней (L0/L1) считается АНАЛИТИЧЕСКИ
 * вдоль луча: радиальные интервалы через пересечение с цилиндрами кольца (дыра
 * вычитается), вертикальная экспонента — в замкнутой форме, маска кромок —
 * тапами по квантилям экспоненциальной массы. Для объёмной дымки используется
 * марш по интервалам (см. v2 ниже).
 *
