...
export const SchwarzschildLensingShaderTemplate: ShaderProps = {
  uniforms: {
    uResolution: new Uniform(new Vector2()),
    uCameraPosition: new Uniform(new Vector3()),
    uRotation: new Uniform(new Vector3()),
    uMaxIterations: new Uniform(0),
    uStepSize: new Uniform(0),
    uDiskInnerRadius: new Uniform(0),
    uDiskOuterRadius: new Uniform(0),
    uDiskTemperature: new Uniform(0),
    uColorScale: new Uniform(0)
  },
  vertexShader: `
    varying vec2 vUv;
