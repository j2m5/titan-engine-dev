 ...
 * коричневый карлик, звезда-гигант. Белый карлик (9) не входит намеренно —
 * его поверхность однородна и поворачивать там нечего
 */
const ORIENTED_CATEGORIES: Set<number> = new Set([3, 4, 8, 10])
