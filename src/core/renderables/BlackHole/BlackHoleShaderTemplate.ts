...
export const BlackHoleShaderTemplate = {
  ...
  fragmentShader: /* glsl */ `
    ...
    // измеримо дороже (изолированный замер: 240→512 стоил +0.35 мс/проход,
    // ~30%). Если когда-нибудь уточнят dphi без подъёма потолка — сюда
    // вернуться. Закреплено tests/blackHole/IntegratorBudget.spec.ts.
