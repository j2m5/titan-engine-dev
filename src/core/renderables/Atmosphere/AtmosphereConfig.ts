 ...
 * мерка (1.6% радиуса), а на газовом гиганте те же 100 км дают 0.05% — полосу
 * в доли процента диска. R/40 держит потолок видимой полосы около 17% радиуса
 * на любом теле, оболочка — 20 шкал (дальше вакуум, граница закреплена
 * правилом checkAtmosphereExtent валидатора).
 *
 * Оболочку ЦЕЛИКОМ мельче порога углового размера (top/dist, `MIN_ANGULAR` в
 * AtmosphereEffect.ts) эффект отсеивает; к толщине видимой полосы это
 * отношения не имеет.
 */
