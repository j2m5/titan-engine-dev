 ...
 * в доли процента диска (оболочки мельче MIN_ANGULAR эффект и вовсе
 * отсеивает). R/40 держит потолок видимой полосы около 17% радиуса на любом
 * теле, оболочка — 20 шкал (дальше вакуум, граница закреплена правилом
 * checkAtmosphereExtent валидатора).
 */
