 ...
 * одного видимого тела. Заполнение послойное, `(typeRank asc, actorPriority
 * desc)`: карта попадает в набор, только если влезли ВСЕ карты старших слоёв
 * ВСЕХ видимых тел — рельеф важнее косметики любого другого тела, косметика
 * дальнего тела не обгонит рельеф ближнего.
 *
