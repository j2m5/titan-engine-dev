...
export interface IPlanetRenderingObject {
  ...
  /**
   * Сила закатного тинта палубы 0..1 (LUT пропускания атмосферы). 0
   * восстанавливает прежний вид по картинке, но выборки LUT остаются —
   * эффект целиком выключает только отсутствие атмосферы у тела.
   */
