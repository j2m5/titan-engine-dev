...
/**
 * Слой оверлеев (линии орбит): рисует OverlayPass поверх уже лензированного
 * кадра, чтобы схематичные линии не искривлялись линзами чёрной дыры.
 * Основной проход слой не видит
 */
export const OVERLAY_LAYER = 28
