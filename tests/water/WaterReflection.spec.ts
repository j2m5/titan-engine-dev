...
//
// Снимок ОБНОВЛЁН диетой атрибутов патча (L5): атрибут normal снят с
// геометрии, направление вершины — normalize(position + patchCenter) с
// инстансным центром патча. Тоже осознанная правка, тоже пойманная стражем.
