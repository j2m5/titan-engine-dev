...
describe('Данные света суши', () => {
  it('ручки света и steepTint в БД не проставлены — дефолты живут в резолверах', () => {
    const keys = ['terrainOcclusionDirect', 'skyAmbientStrength', 'cloudShadowStrength', 'cloudShadowHeightKm', 'steepTint', 'terrainShadowStrength', 'terrainShadowSoftness', 'iceGlintStrength']
