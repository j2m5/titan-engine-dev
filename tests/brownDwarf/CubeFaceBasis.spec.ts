...
describe('базис граней кубмапы', () => {
  ...
  it('round-trip: направление -> (грань, u, v) -> направление', () => {
    ...
    // Направлений семь, а различных граней шесть: тройная ничья
    // (-0.5,-0.5,-0.5) уходит в -X по порядку сравнений и дублирует грань
    // намеренно — она проверяет тайбрейк, а не покрытие
